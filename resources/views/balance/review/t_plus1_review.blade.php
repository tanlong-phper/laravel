        ...
        <div class="box-body">
            ...
            <div class="wrap">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;">T+1复审</a></li>
                    <li><a href="/balance/review/t_plus7_review" target="_self">T+7复审</a></li>
                </ul>
                <div class="margin-bottom-20">
                    <form action="{{url('balance/review')}}" method="get">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        @foreach($data as $key=>$item)
                            <tr class="one" data-dzd-id="{{$item->dzd_id}}">
                                <th class="text-center"><input name="id-all" class="details_id" type="checkbox"
                                                               value="{{$item->dzd_id}}"></th>
