...
@section('content')
    ...
    <div class="box">
        ...
        <form action="{{ url('product/insale/step3') }}" class="form_submit" method="post">
            {{ csrf_field() }}
        <!-- /.box-header -->
        <div class="box-body">
