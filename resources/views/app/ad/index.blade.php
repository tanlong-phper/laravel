        ...
        <div class="box-body">
            ...
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                <ul id="myTab" class="nav nav-tabs">
                    <li class="active"><a href="{{ route('app/ad') }}">轮播</a></li>
                    <li><a href="{{ route('app/ad/ad_slot') }}">广告位</a></li>
                </ul>


                <h4 class="bg-info" style="padding:5px 10px; font-size:14px; overflow:hidden;">
                    <span style="line-height:34px;">首页轮播列表</span>
                    <div style="float:right;">
                        <button type="button" class="btn btn-default">导出EXCEL</button>
                        <a href="/account/user/create" type="button" class="btn btn-default">新增轮播</a>
                    </div>
                </h4>
                <h4 class="bg-info" style="padding:5px 10px; font-size:14px; overflow:hidden;">
                    <span style="line-height:34px;">批量操作</span>
                    <div style="float:right;">
                        <button type="button" class="btn btn-default">停用轮播</button>
                        <button type="button" class="btn btn-default">启用轮播</button>
