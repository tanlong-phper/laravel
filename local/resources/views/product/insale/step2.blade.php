...
@section('content')
    ...
    <div class="box">
        ...
        <form action="{{ url('product/insale/step2') }}" method="post">
            {{ csrf_field() }}
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        <div class="prop_value_list prop_value_list_{{ $key }}" prop_name="{{ $value->property_name }}">
                            <span class="prop_value_list_checkbox">
                                @foreach($value->property_value as $val)
                                    <label>
                                        <input type="checkbox" class="checkbox prop_checkbox" name="" id="" value_id="{{ $val->value_id }}" value="{{ $val->value_text }}"
                                        @foreach($property as $v)
                                            @if($val->value_id == $v->property_value_id)
                                                 checked
                                            @endif
                                        @endforeach
                    ...
                    <table class="table table-bordered ">
                        ...
                        <tbody class="data price_data">
                            @foreach($sku as $value)
                                <input type="hidden" name="remarks[]" value="{{ $value->remark_temp }}">
                                <tr>
                                    <td>{{ $value->base_attr }}</td>
                                    <td><input class="text sale_price" type="text" name="sale_price[]" value="{{ $value->price }}"></td>
                                    <td><input class="text cost_price" type="text" name="cost_price[]" value="{{ $value->cost_price }}"></td>
                                    <td><input class="text market_price" type="text" name="market_price[]" value="{{ $value->market_price }}"></td>
                                    <td><input class="text stock" type="text" name="stock[]" value="{{ $value->stock }}"></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="data point_data">
                            @foreach($sku as $value)
                                <tr>
                                    <td>{{ $value->base_attr }}</td>
                                    <td><input class="text" type="text" name="hl_integral[]" value="{{ $value->hl_integral }}"></td>
                                    <td><input class="text" type="text" name="pv[]" value="{{ $value->pv }}"></td>
                                    <td><input class="text" type="text" name="ga_integral[]" value="{{ $value->ga_integral }}"></td>
                                    <td><input class="text" type="text" name="haolian[]" value="0"></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
