...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form action="{{ url('account/department/update') }}" method="put" class="js-ajax-form">
                {{ csrf_field() }}
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <label><b>部门名称：</b><input type="text" name="name" class="form-control" value="{{ $lists->name }}"></label>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <select class="form-control" name="pid">
                            ...
                            @foreach($departments as $values)
                                ...
                                <option value="{{ $values->id }}" @if($values->id == $lists->pid) selected @endif>{{ $values->name }}</option>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select class="form-control" name="status">
                            <option value="1" @if($lists->status) selected @endif>启用</option>
                            <option value="0" @if(!$lists->status) selected @endif>不启用</option>
                        </select>
                    </div>
                </div>
