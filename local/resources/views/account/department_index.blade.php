        ...
        <div class="box-body">
            ...
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <h4 class="bg-info" style="padding:5px 10px; font-size:14px; overflow:hidden;">
                    ...
                    <div style="float:right;">
                        <a href="/account/department/create" type="button" class="btn btn-default">新增部门</a>
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                            ...
                            @foreach($department_lists as $value)
                                ...
                                <tr role="row">
                                    ...
                                    <td>{{ $value->parent_depart_name }}</td>
                                    <td>{{ $value->created_at }}</td>
                                    <td><span>
                                        <a href="{{ url('account/department/updateStatus',['id'=>$value->id,'status'=>$value->status]) }}" class="layer-get">
                                            @if($value->status) 停用 @else 启用 @endif
                                        </a>&nbsp;
                                        <a href="{{ url('account/department/'.$value->id.'/edit') }}">编辑</a>&nbsp;
                                        <a href="{{ url('account/department',['id'=>$value->id]) }}" token="{{ csrf_token() }}" class="layer-delete">删除</a>
                                    </span></td>
