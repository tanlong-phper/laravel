    ...
    <div class="wrap js-check-wrap">
        ...
        <form method="post" class="form-horizontal" id="enter_form">
            <div class="row-fluid">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th width="15%">店铺名称</th>
                        <td>
                            <input value="{{ $data->merchant_name }}" name="merchant_name" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">经营性质</th>
                        <td>
                            <input value="{{ $data->merchant_type }}" name="merchant_type" type="text">
                        ...
                        <td>
                            ...
                            <select name="region" required>
                                ...
                                @foreach($region as $item)
                                    <option value="{{$item->area_id}}" @if(isset($data->region) and $data->region==$item->area_id) selected @endif >{{$item->area_name}}</option>
                                @endforeach
                            </select>
                        </td>
                        </td>
                    ...
                    <tr>
                        <th width="10%">详细地址</th>
                        <td>
                            <input value="{{ $data->merchant_address }}" name="merchant_address" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">注册账号</th>
                        <td>
                            <input value="{{ $data->nodecode }}" name="nodecode" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">商家折扣</th>
                        <td>
                            <input value="{{ $data->rebate }}" name="rebate" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">法人姓名</th>
                        <td>
                            <input value="{{ $data->corpman_name }}" name="corpman_name" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">法人身份证证</th>
                        <td>
                            <input value="{{ $data->corpman_id }}" name="corpman_id" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">法人联系方式</th>
                        <td>
                            <input value="{{ $data->corpman_mobile }}" name="corpman_mobile" type="text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div style="margin-top:20px;max-width: 100% ;display: inline-block;">
                                ...
                                @else
                                    <div class="goods_img">
                                        <img class='thumb' src="/static/admin/assets/images/default-thumbnail.png" style="height:120px;" />
                                        <input type="file" name="goods_image" onchange="upload(this)" />
                    ...
                    <tr>
                        <th width="10%">客服电话</th>
                        <td>
                            <input value="{{ $data->service_phone }}" name="service_phone" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">开户户名</th>
                        <td>
                            <input value="{{ $data->bank_account_name }}" name="bank_account_name" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">开户银行</th>
                        <td>
                            <input value="{{ $data->bank_name }}" name="bank_name" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">开户行支行</th>
                        <td>
                            <input value="{{ $data->bank_branch }}" name="bank_branch" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">开户行账号</th>
                        <td>
                            <input value="{{ $data->bank_account_no }}" name="bank_account_no" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">联系人</th>
                        <td>
                            <input value="{{ $data->contact_name }}" name="contact_name" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">电话</th>
                        <td>
                            <input value="{{ $data->contact_mobile }}" name="contact_mobile" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">邮箱</th>
                        <td>
                            <input value="{{ $data->contact_email }}" name="contact_email" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th width="10%">QQ</th>
                        <td>
                            <input value="{{ $data->contact_qq }}" name="contact_qq" type="text">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th width="10%">备注信息</th>
                        <td>
                            <textarea name="remark" id="remark" value="" style="width: 30%; height: 70px;" placeholder="请填写备注信息">{{$data->remark or '' }}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th width="10%">设置密码</th>
                        <td>
                            <input value="" name="passwd" type="text">
                        </td>
                    </tr>
            ...
            <div class="form-actions">
                ...
                <input type="hidden" name="apply_id" value="{{ $data->id }}">
                <a id="apply_enter" class="btn btn-primary" _id="{{$id}}">入驻</a>
...
@section('js')
    ...
    <script>
        $('#apply_enter').click(function() {
            ...
            if(confirm("确定要入驻吗？")){
                $.post("{{asset('store/review/apply_enter')}}", $('#enter_form').serialize(), function(data){
                    if(data.status == 1){
                        layer.msg(data.info, {icon:1});
                        window.location.href="{{asset('store/review')}}";
                    }else{
